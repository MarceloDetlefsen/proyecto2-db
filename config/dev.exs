...
config :tienda_albumes, TiendaAlbumesWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "1fBBu84z4r4R5O7uF/WWQQ6POj/QDAVwbHWDiHaSoDyh1uEX7fYtEZlAyxEU//7e",
  watchers: [
...
config :tienda_albumes, TiendaAlbumesWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/tienda_albumes_web/router\.ex$"E,
      ~r"lib/tienda_albumes_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :tienda_albumes, dev_routes: true
